...
| `lifecycle-mutation-failure-cases.json`                                                   | Case payload schema | Problem Details schema selected by each case's `schema` field; cases cover unpublish and lifecycle mutation endpoint failure mappings                                                                                                                                                         |
