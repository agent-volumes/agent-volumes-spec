...
<CardGroup cols={2}>
  <Card title="Schema ID URLs" icon="braces" href="/uri-publications/schema-ids">
    Versioned JSON Schema `$id` publication pages for the v0.1.0-rc.1 artifact set.
  </Card>
  <Card title="SPDX namespace" icon="diagram-project" href="/uri-publications/spdx-external-dependency-namespace">
    URI-backed SPDX extension terms for external dependency declarations.
  </Card>
  <Card title="in-toto predicate" icon="route" href="/uri-publications/in-toto-external-dependency-predicate">
    Optional predicate identifier for declaration-plane external dependency metadata.
  </Card>
  <Card title="Problem Details types" icon="triangle-exclamation" href="/problems">
    Stable pages for every closed v0.1 Problem Details type URI.
  </Card>
  <Card title="Reserved namespaces" icon="lock" href="/uri-publications/reserved-extension-namespaces">
    Reserved capability extension namespace keys for the release line.
  </Card>
  <Card
    title="PURL/VERS exceptions"
    icon="arrows-left-right"
    href="/uri-publications/purl-vers-compatibility-exceptions"
  >
    Machine-readable compatibility exceptions for validation and warning context.
  </Card>
  <Card title="Upstream baselines" icon="code-branch" href="/uri-publications/upstream-baselines">
