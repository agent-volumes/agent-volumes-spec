...
All successful responses return `application/json`. Error responses return `application/problem+json` following [RFC 9457 Problem Details](https://www.rfc-editor.org/rfc/rfc9457).
