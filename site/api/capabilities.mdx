...
<ResponseField name="extensions" type="object">
  ...
  leading hyphen, trailing hyphen, or consecutive hyphens. The namespace keys `agent-volumes`, `core`, and `spec` are
  reserved for the specification and cannot be used for ordinary extensions.
</ResponseField>
