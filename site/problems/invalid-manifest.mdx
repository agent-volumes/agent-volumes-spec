...
description: 'Stable Problem Details type URI page for invalid-manifest.'
---

`https://agentvolumes.org/problems/invalid-manifest` identifies the `invalid-manifest` Problem Details type.
...
- [v0.1.0-rc.1 problem page](/spec/0.1.0-rc.1/problems/invalid-manifest)
