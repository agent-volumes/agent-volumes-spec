...
description: 'Stable Problem Details type URI page for authentication-required in the Agent Volumes v0.1 Registry API.'
---

`https://agentvolumes.org/problems/authentication-required` identifies the `authentication-required` Problem Details type in the closed Agent Volumes v0.1 portable problem set.
