...
<CardGroup cols={2}>
  ...
  <Card title="SPDX namespace" icon="diagram-project" href="/spec/0.1.0-rc.1/uri-publications/spdx-external-dependency-namespace">
    URI-backed SPDX extension terms for external dependency declarations.
  </Card>
  <Card title="in-toto predicate" icon="route" href="/spec/0.1.0-rc.1/uri-publications/in-toto-external-dependency-predicate">
  ...
  <Card title="PURL/VERS exceptions" icon="arrows-left-right" href="/spec/0.1.0-rc.1/uri-publications/purl-vers-compatibility-exceptions">
