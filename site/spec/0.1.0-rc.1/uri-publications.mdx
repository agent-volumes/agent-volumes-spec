...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="lock"
    href="/spec/0.1.0-rc.1/uri-publications/reserved-extension-namespaces"
  >
  ...
  <Card
    title="Upstream baselines"
    icon="code-branch"
    href="/spec/0.1.0-rc.1/uri-publications/upstream-baselines"
  >
  ...
  <Card
    title="BOM/profile identifiers"
    icon="id-card"
    href="/spec/0.1.0-rc.1/uri-publications/bom-profile-identifiers"
  >
