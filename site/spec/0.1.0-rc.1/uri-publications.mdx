...
<CardGroup cols={2}>
  <Card title="Schema ID URLs" icon="file-code" href="/spec/0.1.0-rc.1/uri-publications/schema-ids">
  ...
  <Card title="SLSA manual build type" icon="hammer" href="/spec/0.1.0-rc.1/build/manual/v0.1">
