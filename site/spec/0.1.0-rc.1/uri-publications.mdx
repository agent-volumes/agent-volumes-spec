...
| SPDX extension JSON-LD context             | `https://agentvolumes.org/spec/0.1.0-rc.1/contexts/spdx-external-dependency-declarations-v0.1.jsonld`                      | `site/spec/0.1.0-rc.1/contexts/spdx-external-dependency-declarations-v0.1.jsonld`; `conformance/fixtures/mapping-sample.json`; ADR-0141                                                                   | Release-versioned context artifact. Record dereference and content-type checks with namespace evidence before tagging.              |
