...
All Agent Volumes ADRs follow the [MADR](https://adr.github.io/madr/) format, so each record uses a consistent structure for context, decision, consequences, and related discussion.
