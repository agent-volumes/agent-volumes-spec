...
<Steps>
  <Step title="Create an upload intent">
    ...
    The `201 Created` response mirrors the schema-backed intent record, including the bound subject, attachment metadata,
    declared digest, upload instructions, expiration time, and intent state:
  ...
  <Step title="Finalize the upload">
    ...
    The `201 Created` response includes the finalized attachment identity, bound subject, artifact digest, status, and detail
    URL:
