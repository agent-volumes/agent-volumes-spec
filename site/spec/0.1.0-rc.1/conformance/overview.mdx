...
<Note>
  Passing fixtures earns you `artifact-fixture-pass`, not a certification badge. These labels are
  statements about the artifact and vector surface only.
</Note>
...
<Tip>
  Treat this table as a checklist. For each choice your implementation makes, write it down in your
  own README or documentation so that users know what to expect.
</Tip>
