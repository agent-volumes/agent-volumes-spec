...
<Note>
  The public site summarizes the schema families for readers. Use the repository artifacts for validation and release
  review: `schemas/README.md`, the individual `schemas/*.json` files, and the fixture mappings under
...
<CardGroup cols={2}>
  ...
  <Card title="Requirement inventory" icon="list-check" href="/conformance/requirements">
