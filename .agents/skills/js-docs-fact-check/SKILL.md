...
// Verdict: Needs nuance - this is implementation-dependent
```
...
**Verified by:** [Name]
**Date:** YYYY-MM-DD
**Recommendation:** Ready to publish | Fix issues first | Major revision needed
```
...
4. **Verify against the spec** — For edge cases and "how it works" claims
5. **Verify external resources** — Must be accessible, accurate, and JavaScript-focused
6. **Audit technical claims** — Watch for misconceptions and unsupported statements
7. **Document everything** — Use the report template for consistent, thorough reviews
